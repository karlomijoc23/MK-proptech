...
class CroatianRealEstateAPITester:
    ...
    def test_root_endpoint(self):
        ...
        success, response = self.run_test("API Root Endpoint", "GET", "", 200)
    ...
    def test_dashboard(self):
        ...
        success, response = self.run_test(
            "Dashboard Croatian Metrics", "GET", "dashboard", 200
        )
        if success:
            expected_fields = [
                "ukupno_nekretnina",
    ...
    def test_get_nekretnine(self):
        ...
        success, response = self.run_test(
            "Get All Properties (Nekretnine)", "GET", "nekretnine", 200
        )
    ...
    def test_create_zakupnik(self):
        ...
        success, response = self.run_test(
            "Create Croatian Tenant (Zakupnik)", "POST", "zakupnici", 201, zakupnik_data
        )
    ...
    def test_get_zakupnici(self):
        ...
        success, response = self.run_test(
            "Get All Tenants (Zakupnici)", "GET", "zakupnici", 200
        )
    ...
    def test_create_ugovor(self):
        ...
        success, response = self.run_test(
            "Create Croatian Contract (Ugovor)", "POST", "ugovori", 201, ugovor_data
        )
    ...
    def test_get_ugovori(self):
        ...
        success, response = self.run_test(
            "Get All Contracts (Ugovori)", "GET", "ugovori", 200
        )
    ...
    def test_get_dokumenti(self):
        ...
        success, response = self.run_test(
            "Get All Documents (Dokumenti)", "GET", "dokumenti", 200
        )
    ...
    def test_get_podsjetnici(self):
        ...
        success, response = self.run_test(
            "Get Reminders (Podsjećanja)", "GET", "podsjetnici", 200
        )
        ...
        if success and isinstance(response, dict):
            ...
            for category in search_categories:
                if category in response:
                    count = (
                        len(response[category])
                        if isinstance(response[category], list)
                        else 0
                    )
