...
export default function ProjectDetailsPage() {
  console.log("Rendering ProjectDetailsPage");
  const { id } = useParams();
  ...
  if (!project) {
    return (
      <div className="container py-8 text-center">
        <h2 className="text-xl font-semibold">Projekt nije pronađen</h2>
                  ...
                  <div className="flex items-start gap-4 p-4 border rounded-lg bg-muted/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {linkedProperty.adresa}, {linkedProperty.grad}
                      </p>
                      <div className="flex gap-4 mt-2 text-sm">
                        ...
                        <span>
                          Tip: <strong>{linkedProperty.tip_nekretnine}</strong>
                        </span>
                      </div>
                    </div>
                    <Button
