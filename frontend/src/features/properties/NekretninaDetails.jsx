    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="pregled" className="w-full">
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
            ...
            {(() => {
              const calculateOccupancy = (propertyId, allUnits) => {
                ...
                if (units.length === 0)
                  return { percent: 0, occupied: 0, total: 0 };
              ...
              const occupancy = calculateOccupancy(nekretnina.id, units);
                ...
                <TableBody>
                  {financialHistory.map((item) => (
                    <TableRow key={item.year}>
                      ...
                      <TableCell
                        className={`text-right font-bold ${item.neto >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
        ...
        <TabsContent value="units" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Podprostori</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              {loadingUnits ? (
                <div className="text-center py-4 text-muted-foreground">
                  Učitavanje podprostora...
                </div>
              ) : units.length === 0 ? (
                <div className="text-center py-4 text-muted-foreground">
                  Nema definiranih podprostora.
                </div>
              ) : (
                <Table>
                  <TableHeader>
